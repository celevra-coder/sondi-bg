...
import { getGwbProfile } from "@/lib/gwb-profile.section4-preview";
    ...
    <main style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <Card
            title="6. Мониторинг"
            subtitle="Тенденции, питейни пунктове, превишения и прагови стойности."
          >
            <Row
              label="Времеви серии"
            ...
            {exceedances.length > 0 ? (
              ...
              >
                <summary style={{
                  ...
                  Установени превишения ({exceedances.length})
                </summary>
              ...
              <div style={{
                ...
                В наличните записи няма установени
                превишения.
              </div>
            )}
            ...
            {thresholds.length > 0 ? (
              ...
              <div style={{
                ...
                За това подземно водно тяло няма
                надеждно свързани прагови стойности.
                Не е извършвано предположително
