...
export default async function ProPage({
  ...
  if (nearbyWellCount5Km > 0) {
    drillingPerspectiveParts.push(
      `В радиус до 5 km са отчетени ${nearbyWellCount5Km} официални сондажа.`
    );
  }

  if (nearbySpringCount5Km > 0) {
    drillingPerspectiveParts.push(
      `В същия район са отчетени ${nearbySpringCount5Km} извора или каптажа.`
    );
  }
  ...
  if (nearestWellDistanceKm != null) {
    drillingRecommendationParts.push(
      `Най-близкият регистриран сондаж е на ${formatNumber(nearestWellDistanceKm, 2)} km.`
    );
  }

  if (nearestWellDepth != null) {
    drillingRecommendationParts.push(
      `За него е посочена дълбочина ${formatNumber(nearestWellDepth, 0)} m. Това е сравнителен ориентир, а не препоръчана или гарантирана дълбочина за имота.`
    );
  }
          ...
          >
              ...
              <>
                <details style={{
                  ...
                  <div style={{ marginTop: 10 }}>
                    ...
                    <Row
                      label="Дълбочина на близък сондаж"
                      value={
            ...
            {nearestWellDepth != null && (
              <div style={{
                ...
                Посочената дълбочина се отнася за друг
