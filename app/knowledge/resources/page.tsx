export const metadata = {
  alternates: { canonical: "/knowledge/resources" },

  title: "Водовземане и ресурси",
  description: "Разбери как се оценява наличният ресурс, как се отчита водовземането и как да тълкуваш експлоатационния индекс, свободния ресурс и разрешителните в анализите на.",
};
