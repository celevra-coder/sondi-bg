export const metadata = {
  ...
  title: "Подземните води, подредени по теми.",
  description: "Избери тема и разгледай конкретните материали в нея. Съдържанието е организирано от основните понятия към практическото им приложение.",
};
