export const metadata = {
  alternates: { canonical: "/knowledge/groundwater" },

  title: "Подземните води от основите до практиката.",
  description: "Как се образуват, къде се намират, как се движат и защо условията могат да се променят само на няколко десетки метра разстояние.",
};
