export const metadata = {
  alternates: { canonical: "/knowledge/water-quality" },

  title: "Качеството на водата и факторите, които го променят.",
  description: "Химично състояние, замърсяване, нитрати, защитени зони и други показатели, които помагат да разберем какво се случва с подземните води.",
};
...
const groups = [
  ...
  {
    title: "Обществени консултации и местни сигнали",
    intro:
      "Как се обсъждат проблемите с подземните води и как се различават сигналите от официалните оценки.",
    items: [
      {
        title: "Как обществените консултации променят ПУРБ?",
        href: "/knowledge/water-quality/public-consultations",
      },
      {
        title:
          "Сигнал, становище и официална оценка — каква е разликата?",
