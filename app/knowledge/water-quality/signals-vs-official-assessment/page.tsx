...
export const metadata = {
  alternates: { canonical: "/knowledge/water-quality/signals-vs-official-assessment" },

  title:
    "Сигнал, становище и официална оценка: разлики",
  description:
      ...
      <article className="mx-auto max-w-[920px] px-7 py-16">
        ...
        <section className="mt-14 border-t border-[#dce8ea] pt-8">
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-3">
            ...
            >
              Обществени сигнали за подземните води →
            </Link>
            <Link
