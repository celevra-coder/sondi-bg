export const metadata = {
  alternates: { canonical: "/knowledge/monitoring" },

  title: "Мониторинг на подземните води",
  description: "Разбери какво означават мониторинговите пунктове, химичните и количествените измервания, превишенията и тенденциите, които виждаш в анализите на SONDI.BG.",
};
