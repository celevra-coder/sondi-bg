...
const report = JSON.parse(
  fs.readFileSync("qa/bg2-browser-report.json", "utf8")
);
...
(async () => {
  ...
  for (const item of warnings) {
    ...
    try {
      ...
      if (
        ...
        failures.push(
          "DRILLER WRONG/MISSING PRIMARY NAME"
        );
      }
  ...
  console.log("");
  console.log("======================================");
  console.log("BG2 OVERLAP QA SUMMARY");
